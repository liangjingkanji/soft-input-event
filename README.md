...
<p align="center"><a href="https://github.com/liangjingkanji/soft-input-event/releases/download/1.0.8/soft-input-event.apk">下载体验</a>
</p>
...
```groovy
implementation 'com.github.liangjingkanji:soft-input-event:1.0.8'
```
